...
function App() {
  return (
    <div className="App">
  <h2 style="text-align:center;"> Checkpoint 13  React JS </h2>

<div className="container">
<h3> Example </h3>
  <img href="https://www.docplanner.com/images/curitiba.png" />
...
<form style=" width:30%;background-color:gray; margin-left:30%; margin-top:20px;">
